...
require_once($CFG->dirroot . '/blocks/workflow/classes/command_addrolemember.php');
...
require_once($CFG->dirroot . '/blocks/workflow/classes/command_removerolemember.php');
