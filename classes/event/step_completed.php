...
/**
 * Event implementation for workflow and step completed
 *
...
class step_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstepcompleted', 'block_workflow');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed the step '".$this->other['stepname']."' (id = ".$this->other['stepid'].").";
    }
