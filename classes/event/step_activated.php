...
/**
 * Event implementation for workflow and step activated
 *
...
/**
 * This event is triggered when the state of a workflow-step is set to activated.
 *
 ...
 *      - boolean initial: Whether this is the initial activation of the first step of the workflow.
 * }
 */
class step_activated extends \core\event\base {
     ...
     *  @param boolean $initial Whether this is the initial activation of the first step of the workflow.
     *  @return \core\event\base
     */
    public static function create_from_step_state(\block_workflow_step_state $stepstate, $initial = false) {
        return self::create([
    ...
    public static function get_name() {
        return get_string('eventstepactivated', 'block_workflow');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' activated the step '".$this->other['stepname']."' (id = ".$this->other['stepid'].").";
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['initial'])) {
            throw new \coding_exception('The \'initial\' value must be set in \'other\' of the event.');
        }
    }
}
